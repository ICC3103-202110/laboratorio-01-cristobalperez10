...
def ast_mat():                                  #Funcion que me genera la matriz de asteriscos
    ma = table.copy()
    for i in range(2):
...
def end_game():                                         #Funcion para determinar el final del juego
    global points_p1, points_p2                         #cuando no queden cartas en el tablero
    ...
    if total_points == n_cards:
        if points_p1 > points_p2:
            ...
            print("Draw!")
        return 0            
def sum_points(turn,card1,card2):                        #Funcion que va a sumar puntos al que gane
    if card1 == card2:
...
while True:                                                                                #Turno del jugador 1, ingresa las coordenadas de las cartas que quiere voiltear
    if turn == 1:
    ...
    elif turn == 2:                                                                         #Turno del jugador 2, ingresa las coordenadas de las cartas que quiere voiltear
